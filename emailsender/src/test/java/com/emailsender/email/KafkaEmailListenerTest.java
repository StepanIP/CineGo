...
class KafkaEmailListenerTest {
    ...
    void setUp() throws JsonProcessingException {
        emailWithTicket = new EmailWithTicket("example@example.com",
            new TicketDto("Wojtek", "FilmTitle", LocalDate.now(), LocalTime.now(), new BigDecimal("12.00"), 2, 10, 1, TicketType.NORMAL,
                Currency.CLP));
